...
exports.default = _default;
        var $bd5d6e = exports.default || module.exports;
      
      if (typeof $bd5d6e === 'function') {
        $bd5d6e = $bd5d6e.options;
      }
    
        /* template */
        Object.assign($bd5d6e, (function () {
          var render = function () {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$bd5d6e', $bd5d6e);
          } else {
            api.reload('$bd5d6e', $bd5d6e);
          }
        }
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "5005" + '/');
